...
//                        }
    ...
    <body>
        <div id="header" class="row"  style="background:#000;">
		<h1 class="small" style="color:#555;">MaKrosh PROCUREMENT SYSTEM</h1>
...
<!--                                    <li><i class="cus-house"></i> <?php echo $department;?> </li>-->
                                    ...
                                    <li><a style="color: white" href="<?php echo base_url()?>login/logout"><i class="icon-lock"></i> Log out</a></li>
                                </ul>
